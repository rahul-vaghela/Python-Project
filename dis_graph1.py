...
def vid2dens(dr):
    ...
    vidcap1 = cv2.VideoCapture(2,cv2.CAP_DSHOW)
    vidcap2 = cv2.VideoCapture(3,cv2.CAP_DSHOW)
    vidcap3 = cv2.VideoCapture(4,cv2.CAP_DSHOW)
    vidcap4 = cv2.VideoCapture(1,cv2.CAP_DSHOW)
